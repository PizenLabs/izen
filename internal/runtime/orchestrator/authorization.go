...
func (o *PhaseManager) BindAuthorizedMicroPlan(ctx context.Context, dag *planner.ExecutionDAG) error {
	if o == nil {
...
func (o *PhaseManager) InjectEphemeralPlan(source string) error {
	if o == nil {
		return fmt.Errorf("orchestrator: nil receiver")
	}
	if source == "" {
...
func (o *PhaseManager) RegisterSyntheticMicroPlan(targets []string, intent, scope string, capabilities []string) error {
	if o == nil {
		return fmt.Errorf("orchestrator: nil receiver")
	}
	if len(targets) == 0 {
...
func (o *PhaseManager) EnsureSyntheticMicroPlan(targets []string, intent, scope string, capabilities []string) error {
	if o == nil {
		return fmt.Errorf("orchestrator: nil receiver")
	}
	o.mu.RLock()
...
func (o *PhaseManager) SyntheticMicroPlan() *SyntheticMicroPlan {
	if o == nil {
		return nil
	}
	o.mu.RLock()
...
func (o *PhaseManager) HasAuthorizedPlan() bool {
	if o == nil {
		return false
	}
	o.mu.RLock()
...
func (o *PhaseManager) AuthorizedMicroPlan() *MicroPlan {
	if o == nil {
		return nil
	}
	o.mu.RLock()
...
func (o *PhaseManager) ActiveEphemeralPlan() *EphemeralPlan {
	if o == nil {
		return nil
	}
	o.mu.RLock()
...
func (o *PhaseManager) ClearAuthorizedPlan() {
	if o == nil {
		return
	}
	o.mu.Lock()
