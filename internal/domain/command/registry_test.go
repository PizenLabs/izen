...
func TestAllEnumeration(t *testing.T) {
	...
	if !equalStrings(globalNames, []string{"arch", "checkpoint", "clear", "commit", "compact", "copy", "drop", "explain-decision", "help", "models", "new", "objective", "provider", "quit", "session", "settings", "undo", "usage"}) {
