// Package capability — profile definitions (canonical home of
// internal/core/capability profiles).
//
// Ported from internal/core/capability/profiles.go verbatim (STEP 3A parity):
// named capability profiles over the canonical CapabilitySet. Depends only on
// the types in capability.go (same package) and the standard library.
package capability
