...
// Compile-time assertion that semanticCapability satisfies CapabilityContract.
var _ CapabilityContract = (*semanticCapability)(nil)
...
func NewPortfolioWebsite() CapabilityContract {
...
func NewSemanticHTML() CapabilityContract {
	return &semanticCapability{
		id:   CapSemanticHTML,
...
func NewTypeScript() CapabilityContract {
	return &semanticCapability{
		id:   CapTypeScript,
...
func NewGoBackend() CapabilityContract {
	return &semanticCapability{
		id:   CapGoBackend,
...
func NewGenericCode() CapabilityContract {
	return &semanticCapability{
		id:          CapGenericCode,
...
// registration order.
func DefaultCapabilities() []CapabilityContract {
