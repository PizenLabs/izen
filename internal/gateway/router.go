...
var frontendUIWordPatterns = []*regexp.Regexp{
	...
	regexp.MustCompile(`\bwebsite\b`),
	regexp.MustCompile(`\bhomepage\b`),
	regexp.MustCompile(`\bportfolio\b`),
	regexp.MustCompile(`\bprofile\b`),
	regexp.MustCompile(`\blanding\b`),
	regexp.MustCompile(`\brewrite\b`),
