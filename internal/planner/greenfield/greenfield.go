...
// Compile-time assertion that GreenfieldPlanner satisfies planner.PlanBuilder.
var _ planner.PlanBuilder = (*GreenfieldPlanner)(nil)
...
// Plan implements planner.PlanBuilder. It lowers every writable file artifact
